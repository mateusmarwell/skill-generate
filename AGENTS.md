# Rules for skill-generator Repository
...
- The same rule applies in reverse: if `README.pt-BR.md` is updated directly, its English counterpart must be updated accordingly.
